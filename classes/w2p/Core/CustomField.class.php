...
class w2p_Core_CustomField
{
    ...
    // TODO - data type, meant for validation if you just want numeric data in a 
    // text input but not yet implemented
    ...
    public function store($object_id)
    {
        ...
        if ($object_id) {
            ...
            return 'Error: Cannot store field (' . $this->field_name . '),
                    associated id not supplied.';
        }
    }
