...
class w2p_Core_CustomFieldManager extends w2p_Core_BaseObject
{
    ...
    public function __construct()
    {
        ...
        $this->html_types = array('textinput' => 'Text Input', 'textarea' =>
            'Text Area', 'checkbox' => 'Checkbox', 'select' => 'Select List',
            'label' => 'Label', 'separator' => 'Separator', 'href' => 'Weblink');
    }
    ...
    public function getModuleList()
    {
        ...
        $q->addWhere("mod_directory IN ('companies', 'projects', 'tasks', 'calendar',
                     'contacts')");
