...
-- 
-- Host: localhost
-- Generation Time: Jan 12, 2010 at 11:56 PM
...
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES (11, 'company_name', 'web2Project v1.2.2 Demo Site', 'admin_system', 'text');
...
INSERT INTO `tasks` (`task_id`, `task_name`, `task_parent`, `task_milestone`, `task_project`, `task_owner`, `task_start_date`, `task_duration`, `task_duration_type`, `task_hours_worked`, `task_end_date`, `task_status`, `task_priority`, `task_percent_complete`, `task_description`, `task_target_budget`, `task_related_url`, `task_creator`, `task_order`, `task_client_publish`, `task_dynamic`, `task_access`, `task_notify`, `task_departments`, `task_contacts`, `task_custom`, `task_type`, `task_updator`, `task_created`, `task_updated`, `task_dep_reset_dates`) VALUES (1, 'Task #1', 1, 0, 1, 1, date_add(NOW(), INTERVAL 6 DAY), 40, 1, 3, date_add(NOW(), INTERVAL 10 DAY), 0, 0, 20, NULL, 0.00, '', 1, 0, 0, 0, 0, 1, NULL, NULL, NULL, 0, 0, NOW(), NOW(), 0);
INSERT INTO `tasks` (`task_id`, `task_name`, `task_parent`, `task_milestone`, `task_project`, `task_owner`, `task_start_date`, `task_duration`, `task_duration_type`, `task_hours_worked`, `task_end_date`, `task_status`, `task_priority`, `task_percent_complete`, `task_description`, `task_target_budget`, `task_related_url`, `task_creator`, `task_order`, `task_client_publish`, `task_dynamic`, `task_access`, `task_notify`, `task_departments`, `task_contacts`, `task_custom`, `task_type`, `task_updator`, `task_created`, `task_updated`, `task_dep_reset_dates`) VALUES (2, 'Dynamic Task', 2, 0, 1, 1, NOW(), 142, 1, 0, date_add(NOW(), INTERVAL 22 DAY), 0, 0, 0, NULL, 0.00, '', 1, 0, 0, 1, 0, 1, NULL, NULL, NULL, 0, 0, NOW(), NOW(), 0);
INSERT INTO `tasks` (`task_id`, `task_name`, `task_parent`, `task_milestone`, `task_project`, `task_owner`, `task_start_date`, `task_duration`, `task_duration_type`, `task_hours_worked`, `task_end_date`, `task_status`, `task_priority`, `task_percent_complete`, `task_description`, `task_target_budget`, `task_related_url`, `task_creator`, `task_order`, `task_client_publish`, `task_dynamic`, `task_access`, `task_notify`, `task_departments`, `task_contacts`, `task_custom`, `task_type`, `task_updator`, `task_created`, `task_updated`, `task_dep_reset_dates`) VALUES (3, 'First Child Task', 2, 0, 1, 1, NOW(), 112, 1, 0, date_add(NOW(), INTERVAL 18 DAY), 0, 0, 0, NULL, 0.00, NULL, 1, 0, 0, 0, 0, 1, NULL, NULL, NULL, 0, 0, NOW(), NOW(), 0);
INSERT INTO `tasks` (`task_id`, `task_name`, `task_parent`, `task_milestone`, `task_project`, `task_owner`, `task_start_date`, `task_duration`, `task_duration_type`, `task_hours_worked`, `task_end_date`, `task_status`, `task_priority`, `task_percent_complete`, `task_description`, `task_target_budget`, `task_related_url`, `task_creator`, `task_order`, `task_client_publish`, `task_dynamic`, `task_access`, `task_notify`, `task_departments`, `task_contacts`, `task_custom`, `task_type`, `task_updator`, `task_created`, `task_updated`, `task_dep_reset_dates`) VALUES (4, 'Second Child', 2, 0, 1, 1, date_add(NOW(), INTERVAL 20 DAY), 30, 1, 0, date_add(NOW(), INTERVAL 22 DAY), 0, 0, 0, NULL, 0.00, NULL, 1, 0, 0, 31, 0, 1, NULL, NULL, NULL, 0, 0, NOW(), NOW(), 0);
...
CREATE TABLE `task_log` (
  ...
  `task_log_changelog_description` mediumtext,
  `task_log_changelog_backout_plan` mediumtext,
...
INSERT INTO `task_log` (`task_log_id`, `task_log_task`, `task_log_help_desk_id`, `task_log_name`, `task_log_description`, `task_log_creator`, `task_log_created`, `task_log_updator`, `task_log_updated`, `task_log_hours`, `task_log_date`, `task_log_costcode`, `task_log_problem`, `task_log_reference`, `task_log_related_url`, `task_log_project`, `task_log_company`, `task_log_changelog`, `task_log_changelog_servers`, `task_log_changelog_whom`, `task_log_changelog_datetime`, `task_log_changelog_duration`, `task_log_changelog_expected_downtime`, `task_log_changelog_description`, `task_log_changelog_backout_plan`) VALUES (1, 1, 0, 'Task #1', 'I did some work on my task.', 1, NOW(), 0, NOW(), 3, NOW(), '', 0, 0, NULL, 0, 0, 0, '', 0, NULL, '', 0, NULL, NULL);
...
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (427, '1.0.0', 1, NOW(), NOW());
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 1, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (489, '1.0.0', 0, '0000-00-00', NOW());
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 6, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 7, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 8, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 9, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 10, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 11, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '1.1.0', 12, '0000-00-00', NOW());
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 12, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 13, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 14, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 15, NOW(), '0000-00-00');
INSERT INTO `w2pversion` (`code_revision`, `code_version`, `db_version`, `last_db_update`, `last_code_update`) VALUES (0, '', 16, NOW(), '0000-00-00');
