...
window.extend({
	...
	*/
	...
	getScrollLeft: function(){
		...
		return this.pageXOffset || document.body.scrollLeft;
	},
	...
	*/
	...
	getScrollTop: function(){
		...
		return this.pageYOffset || document.body.scrollTop;
	},
...
//w2p
		this.fx = new Fx.Style(this.toolTip, 'opacity', {duration: 125, wait: false}).set(0);
//w2p
		if (this.options.initialize) this.options.initialize.call(this);
	},
