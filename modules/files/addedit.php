...
// If this user is able to edit projects it should have two additional file types: 
// 'Main Project Picture' and 'Project Pictures'.
$file_categs = w2PgetSysVal('FileType');
if (canEdit('projects')) {
	$file_categs = $file_categs + array(9998 => $AppUI->_('Project Pictures'), 9999 => $AppUI->_('Main Project Picture'));
}
		...
		<tr>
			<td width="80%" valign="top" align="center">
				<table cellspacing="1" cellpadding="2" width="60%">
					...
					<?php } ?>
					<?php echo file_show_attr($companies, $file_categs); ?>
					<tr>
