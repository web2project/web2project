...
$successPath = ($delete && $message_id == $message_parent) || $message_parent == -1?
		'm=forums&a=view&forum_id='.$forum_id :
	'm=forums&a=view&forum_id='.$forum_id.'&message_id='.$message_parent;

$errorPath = 'm=forums&a=view&forum_id='.$forum_id.'&message_parent='.
