    ...
    ?>
        <tr>
            <td colspan="12">
                ...
                <?php if ($canAuthor) { ?>
                    <input type="button" class="button right" value="<?php echo $AppUI->_('start a new topic'); ?>" onclick="javascript:window.location='./index.php?m=forums&a=view&forum_id=<?php echo $forum_id; ?>&post_message=1';" />
                <?php } ?>
            </td>
        </tr>
    </table>
