...
$show_inactive = w2PgetParam($_POST, 'show_inactive', 'off');
	...
	<table cellspacing="0" cellpadding="4" border="0" width="100%" class="std">
		<tr>
			...
			<td nowrap="nowrap">
				...
				<label for="use_period"><?php echo $AppUI->_('Use the period'); ?></label><br />
				<input type="checkbox" name="show_inactive" id="show_inactive" <?php if ('on' == $show_inactive) { echo 'checked="checked"'; } ?> />
				<label for="show_inactive"><?php echo $AppUI->_('Show inactive tasks'); ?></label>
			</td>
