<?php
//this view is added because at the moment, we can loose display of inactive tasks
//goto project designer, set a task to inactive: it is gone from project designer view.
//showing inactive tasks under main menu tasks is broken
//tasks (inactive) in projectview looses treeview of tasks
//opto 2016-6-30
//
...
//not in the all tasks tab of project view
...
if ($task_id) {
    ...
    foreach ($projects as $k => $p) {
        ...
        if ('projects' == $m || 'projectdesigner' == $m) {
            $taskTree = $tempTask->getTaskTree($k, 0, 9999);
            echo $listTable->buildRows($taskTree, $customLookups);
        }
    }
}
