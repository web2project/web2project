    ...
    <body onload="this.focus();">
        <div class="std titlebar">
            <div class="left">
                <a href="http://www.w8.se/" target="_new">
                    <img src="style/<?php echo $uistyle; ?>/images/wp_icon.gif" border="0" />
                </a>
            </div>
            <div class="right">
                <a href="http://www.web2project.net/" target="_new">
                    <?php echo w2PtoolTip('web2Project v. ' . $AppUI->getVersion(), 'click to visit web2Project site', true);?>
                        <img src="style/<?php echo $uistyle; ?>/images/title.png" border="0" class="banner" align="left" alt="click to visit web2Project site" />
                    <?php echo w2PendTip();?>
                </a>
            </div>
        </div>
        ...
        if (!$dialog) {
            ...
            <form name="frm_new" method="get" action="./index.php" accept-charset="utf-8">
                ...
                <div class="header">
                    <div class="left nav">
                        <?php echo buildHeaderNavigation($AppUI, '', '', ' | ', $m); ?>
                    </div>
