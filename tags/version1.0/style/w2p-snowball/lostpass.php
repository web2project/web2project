...
<head>
	...
	<link rel="stylesheet" type="text/css" href="./style/w2p-snowball/main.css" media="all" />
	<style type="text/css" media="all">@import "./style/w2p-snowball/main.css";</style>
...
<tbody>
	<tr>
	<td width="100%" valign="top" align="left" style="background: transparent url(./style/w2p-snowball/nav_shadow.jpg) repeat-x scroll 0%;">
		<img width="1" height="13" border="0" src="./style/w2p-snowball/nav_shadow.jpg"/>
	</td>
</tr>
</tbody>
</table>
