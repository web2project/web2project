...
--
-- Host: localhost
-- Generation Time: Mar 03, 2008 at 03:34 AM
...
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(1, 'host_locale', 'en', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(2, 'check_overallocation', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(3, 'currency_symbol', '$', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(4, 'host_style', 'web2project', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(5, 'company_name', 'web2Project Development', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(6, 'page_title', 'web2Project', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(7, 'site_domain', 'web2project.net', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(8, 'email_prefix', '[web2Project]', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(9, 'admin_username', 'admin', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(10, 'username_min_len', '4', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(11, 'password_min_len', '4', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(12, 'enable_gantt_charts', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(13, 'log_changes', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(14, 'check_task_dates', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(15, 'locale_warn', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(16, 'locale_alert', '^', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(17, 'daily_working_hours', '8.0', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(18, 'display_debug', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(19, 'link_tickets_kludge', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(20, 'show_all_task_assignees', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(21, 'direct_edit_assignment', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(22, 'restrict_color_selection', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(23, 'cal_day_view_show_minical', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(24, 'cal_day_start', '8', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(25, 'cal_day_end', '17', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(26, 'cal_day_increment', '15', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(27, 'cal_working_days', '1,2,3,4,5', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(28, 'restrict_task_time_editing', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(29, 'default_view_m', 'calendar', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(30, 'default_view_a', 'day_view', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(31, 'default_view_tab', '1', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(32, 'index_max_file_size', '-1', '', 'text');
...
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(36, 'debug', '1', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(37, 'parser_default', '/usr/bin/strings', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(38, 'parser_application/msword', '/usr/bin/strings', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(39, 'parser_text/html', '/usr/bin/strings', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(40, 'parser_application/pdf', '/usr/bin/pdftotext', '', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(41, 'files_ci_preserve_attr', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(42, 'files_show_versions_edit', 'false', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(43, 'reset_memory_limit', '64M', '', 'text');
...
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(60, 'task_reminder_days_before', '1', 'task_reminder', 'text');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(61, 'task_reminder_repeat', '100', 'task_reminder', 'text');
...
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(66, 'activate_external_user_creation', 'true', '', 'checkbox');
INSERT INTO `config` (`config_id`, `config_name`, `config_value`, `config_group`, `config_type`) VALUES(67, 'projectdesigner_view_project', 'false', '', 'checkbox');
...
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(1, 44, 'sql');
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(2, 44, 'ldap');
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(3, 44, 'pn');
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(4, 33, 'app');
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(5, 33, 'php');
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(6, 51, 'php');
INSERT INTO `config_list` (`config_list_id`, `config_id`, `config_list_name`) VALUES(7, 51, 'smtp');
...
CREATE TABLE `contacts` (
  ...
  `contact_company` int(11) NOT NULL default '0',
  `contact_department` int(11) NOT NULL default '0',
...
CREATE TABLE `custom_fields_struct` (
  ...
  `field_tab` int(11) NOT NULL default '0',
...
CREATE TABLE `events` (
  ...
  `event_task` int(11) default NULL,
...
CREATE TABLE `projects` (
  ...
  `project_keytask` int(11) default '0',
  `project_active` int(1) NOT NULL default '1',
  `project_original_parent` int(11) unsigned NOT NULL default '0',
  `project_parent` int(11) unsigned NOT NULL default '0',
  `project_empireint_special` int(1) NOT NULL default '0',
  `project_updator` int(11) NOT NULL default '0',
  ...
  `project_end_date_adjusted_user` int(11) NOT NULL default '0',
...
CREATE TABLE `tasks` (
  ...
  `task_updator` int(11) NOT NULL default '0',
...
CREATE TABLE `task_dependencies` (
  `dependencies_task_id` int(11) NOT NULL default '0',
  `dependencies_req_task_id` int(11) NOT NULL default '0',
...
CREATE TABLE `task_log` (
  ...
  `task_log_project` int(11) unsigned NOT NULL default '0',
  `task_log_company` int(11) unsigned NOT NULL default '0',
  `task_log_changelog` int(1) unsigned NOT NULL default '0',
  `task_log_changelog_servers` varchar(255) NOT NULL default '',
  `task_log_changelog_whom` int(11) NOT NULL default '0',
...
CREATE TABLE `users` (
  ...
  `user_department` int(11) unsigned NOT NULL default '0',
...
INSERT INTO `users` (`user_id`, `user_contact`, `user_username`, `user_password`, `user_parent`, `user_type`, `user_signature`, `user_empireint_special`, `user_department`, `user_company`) VALUES(1, 1, 'admin', '76a2173be6393254e72ffa4d6df1030a', 0, 1, '', 0, 0, 0);
