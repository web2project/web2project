...
# Format in web2project changelogs format (see http://sourceforge.net/projects/web2project/)
my $W2P_Output = 0;
...
Output sytles:
  ...
  --dp                         Output in web2project's Changelog format
                               (see http://sourceforge.net/projects/web2project/)
