<?php /* $Id$ $URL$ */
/************************************************************************/
/* w2plink                     (lang/eng/admin.php)                      */
/************************************************************************/

/*---ADMIN-TEXT--------------------------------------------------------------*/
define("_MODSUBJECT", "The Location of the web2Project installation");
...
define("_SHIMLINK", "w2PLink 1.01");
define("_SHIMLINKMODIFYCONFIG", "Modify w2PLink Configuration");
define("_SHIMLINKUPDATE", "Update w2PLink Configuration");
/*---END-ADMIN-TEXT----------------------------------------------------------*/
?>