...
if ($canEdit) {
	$titleBlock->addCell();
	$titleBlock->addCell('<input type="submit" class="button" value="' . $AppUI->_('new department') . '">', '', '<form action="?m=departments&a=addedit&company_id=' . $company_id . '&dept_parent=' . $department . '" method="post">', '</form>');
}
...
$min_view = true;
include W2P_BASE_DIR . '/modules/departments/view.php';
?>