...
class Companies_Test extends PHPUnit_Extensions_Database_TestCase
{
    ...
    */
    public function testGetContacts()
    {
        ...
        $this->assertEquals('c1 address 1',             $contacts[1]['10']);
        $this->assertEquals('c1 address 2',             $contacts[1]['11']);
        $this->assertEquals('c1 city',                  $contacts[1]['12']);
        $this->assertEquals('CA',                       $contacts[1]['13']);
        $this->assertEquals('90210',                    $contacts[1]['14']);
        $this->assertEquals('US',                       $contacts[1]['15']);
        $this->assertEquals('c1s notes.',               $contacts[1]['16']);
        $this->assertEquals(0,                          $contacts[1]['17']);
        $this->assertEquals('obj/contact',              $contacts[1]['18']);
        $this->assertEquals(0,                          $contacts[1]['19']);
        $this->assertEquals(0,                          $contacts[1]['20']);
        $this->assertEquals('',                         $contacts[1]['21']);
        $this->assertEquals('2009-01-01 11:11:11',      $contacts[1]['22']);
        $this->assertEquals('2008-12-12 11:11:11',      $contacts[1]['23']);
        ...
        $this->assertEquals('c2 address 1',             $contacts[2]['10']);
        $this->assertEquals('c2 address 2',             $contacts[2]['11']);
        $this->assertEquals('c2 city',                  $contacts[2]['12']);
        $this->assertEquals('CA',                       $contacts[2]['13']);
        $this->assertEquals('90211',                    $contacts[2]['14']);
        $this->assertEquals('US',                       $contacts[2]['15']);
        $this->assertEquals('c2s notes.',               $contacts[2]['16']);
        $this->assertEquals(0,                          $contacts[2]['17']);
        $this->assertEquals('obj/contact',              $contacts[2]['18']);
        $this->assertEquals(0,                          $contacts[2]['19']);
        $this->assertEquals(0,                          $contacts[2]['20']);
        $this->assertEquals('',                         $contacts[2]['21']);
        $this->assertEquals('2008-01-01 11:11:11',      $contacts[2]['22']);
        $this->assertEquals('2007-12-12 11:11:11',      $contacts[2]['23']);
